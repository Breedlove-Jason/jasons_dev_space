...
export const StyledAwardsSection = styled.section`
  ...
  box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.05); // A softer shadow than the comments section
`;
...
export const StyledAward = styled.li`
  ...
  border-radius: 5px;
  box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.05); // Softer shadow for depth
...
export const StyledMedalsBanner = styled.img`
  ...
  max-width: 600px; /* Max width to match the section width */
